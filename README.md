...
:clapper: ```'GGV'``` 프로젝트는<br>
수료 후에도 아직 많은 부분에서 미숙하다고 느껴,<br>
포트폴리오 겸 학습 차원에서 시작하게 된 프로젝트입니다.<br>
그중에서도 영화 예매 사이트가 당시 다른 서비스들에 비해 개성 있고 매력적으로 다가와,<br>
CGV를 모티브로 한 클론 프로젝트를 진행하게 되었습니다.<br>
...
<img src="https://img.shields.io/badge/DB-%23121011?style=for-the-badge"> <img src="https://img.shields.io/badge/Oracle-FF0000?style=for-the-badge&logo=oracle&logoColor=white"> <img src="https://img.shields.io/badge/MySQL-08668E?style=for-the-badge&logo=mysql&logoColor=white">
