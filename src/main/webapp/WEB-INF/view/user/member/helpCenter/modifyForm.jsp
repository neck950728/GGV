...
<head>
	...
	<script type="text/javascript">
		var g_articleCode = "${helpCenter.article_code}";
		var g_articleContent = '${helpCenter.content}';
	</script>
	<script src="${pageContext.request.contextPath}/resources/js/user/member/helpCenter/modifyForm.js"></script>
...
<body>
	<div id="container">
		...
		<div id="contents">
			<form action="${pageContext.request.contextPath}/member/helpCenter/${type}/modifyForm/modify" method="POST">
				<input type="text" name="title" value="${helpCenter.title}" maxlength="50" placeholder="제목">
				<textarea id="summernote" name="content"></textarea>
				<input type="button" class="submit_button" value="등록">
				
				<input type="hidden" name="article_code" value="${helpCenter.article_code}">
				<input type="hidden" name="isPrivate" value="${helpCenter.isPrivate}">
			</form>
		</div>
	</div>
</body>
